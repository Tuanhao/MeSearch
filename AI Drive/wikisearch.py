...
# filter out non-noun words from the list
def selectnoun(wordlist, occurencelist):
    ...
    for i in range(len(wordlist)):
        ...
        # only append noun to the new list and occurence list
        for word, tag in pos:
...
# take top 5 words from the list
